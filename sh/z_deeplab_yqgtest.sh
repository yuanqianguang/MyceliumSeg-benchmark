...
./dist_test.sh /data1/yuanqianguang/_mushroom/model/transformer_model/SegFormer-master/mycelium_model/model/deeplabv3_r50-d8.py /data1/yuanqianguang/_mushroom/model/transformer_model/SegFormer-master/work_dirs/deeplabv3_r50-d8/iter_50000.pth 4 --eval mIoU mDice assd hd95 biou --tmpdir /data1/yuanqianguang/_mushroom/model/transformer_model/SegFormer-master/tmp 